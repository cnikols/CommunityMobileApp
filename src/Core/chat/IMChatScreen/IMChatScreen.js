...
class IMChatScreen extends Component {
  static navigationOptions = ({ screenProps, navigation }) => {
    ...
    //options.headerTitle = title + channel.participants[0].fullname ;
    options.headerTitle = title + ' '+ channel.participants[0].lastName;
    ...
    options.headerLeft = (
      <>
        <IMIconButton
          source={require('../../../CoreAssets/backArrowChat.png')}
          //tintColor={appStyles.styleSet.backArrowStyle.tintColor}
          onPress={() =>  navigation.goBack()}  //props.navigation.goBack()}
          //marginRight={15}
          width={36}
          height={31}
          marginLeft={10}
