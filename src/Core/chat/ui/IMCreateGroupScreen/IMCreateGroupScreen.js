...
class IMCreateGroupScreen extends Component {
  ...
  onCreate = () => {
    ...
    if (checkedFriends.length === 0) {
      alert('Επίλεξε τουλάχιστον δύο γείτονες');
    } else {
  ...
  onSubmitName = name => {
    ...
    if (participants.length < 2) {
      alert(IMLocalized('Επίλεξε τουλάχιστον δύο γείτονες για ομαδική συνομιλία.'));
      return;
    }
    channelManager
