...
function IMCreateGroupComponent(props) {
  ...
  const emptyStateConfig = {
    title: IMLocalized("Αδυναμία δημιουργίας γκρουπ"),
    description: IMLocalized("Δεν έχεις ακόμα αρκετούς γείτονες για να δημιουργήσεις γκρουπ συνομιλίας"),
    buttonName: IMLocalized("Επιστροφή"),
  ...
  return (
    <View style={styles.container}>
      ...
      <DialogInput
        ...
        title={IMLocalized("Όνομα γκρουπ γειτόνων")}
