  ...
  filterOutRelatedPosts = (posts) => {
    ...
    return posts.filter(post => {
      return (
        ...
        post.author && post.author.profilePictureURL && post.author.profilePictureURL != defaultAvatar &&
        post.postMedia &&
        post.postMedia.length > 0 &&
        (!this.props.friends || !this.props.friends.find(friend => friend.id == post.authorID))
      );
    })
  }
