  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.addTitleAndlocationIconContainer}>
            <View style={styles.addTitleContainer}>
              <Text style={styles.addTitle}>
                {!isCameralContainer
                  ? IMLocalized('Προσθήκη φωτογραφίας')
                  : IMLocalized('Προσθήκη φωτογραφίας')}
              </Text>
            </View>
            <View style={styles.iconsContainer}>
              <TNTouchableIcon
                ...
                imageStyle={{position:'relative', left:15}}
      ...
      <ActionSheet
        ...
        title={IMLocalized('Προσθήκη φωτογραφίας')}
        options={[IMLocalized('Ανέβασμα από κινητό'), IMLocalized('Λήψη φωτογραφίας'), IMLocalized('Επιστροφή')]}
        cancelButtonIndex={2}
        onPress={onPhotoUploadDialogDone}
      />
      <ActionSheet
        ref={removePhotoDialogRef}
        title={IMLocalized('Αφαίρεση φωτογραφίας')}
        options={[IMLocalized('Αφαίρεση'), IMLocalized('Επιστροφή')]}
